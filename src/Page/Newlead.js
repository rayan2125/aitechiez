...
import Dropdown, { Campaign, UserRefrel } from '../Library/Dropdown'
...
const Newlead = ({ navigation, route }) => {
    ...
    const sourceLead = ["Referral", "Google", "Facebook", "LinkedIn", "Walkin", "Campaign"];
    ...
    const cancelbtn = () => {
        ...
        //                 setLoader(false)// Go back to the previous screen
        //             }
        //         }
        //     ]
        // );
